...
// simple case
      ...
      3-acc-dtv-pp-v:      (ECM-IP-INF* iDoms nonfinVerbAct) AND (ECM-IP-INF* iDoms acc) AND (ECM-IP-INF* iDoms dtv) AND (ECM-IP-INF* iDoms firstPP)
                       AND (CODING-ECM-IP-INF* column 10 [oO]_Res|[oO]_np|[oO]_pro)
                       AND (CODING-ECM-IP-INF* column 11 [oO]_Res|[oO]_np|[oO]_pro)
                       AND (CODING-ECM-IP-INF* column 14 [oO]_Res|[oO]_np|[oO]_pro)
