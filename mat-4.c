...
// simple case
      ...
      3-acc-dtv-pp-v:      (IP-MAT* iDoms nonfinVerbAct) AND (IP-MAT* iDoms acc) AND (IP-MAT* iDoms dtv) AND (IP-MAT* iDoms firstPP)
                       AND (CODING-IP-MAT* column 10 [oO]_Res|[oO]_np|[oO]_pro)
                       AND (CODING-IP-MAT* column 11 [oO]_Res|[oO]_np|[oO]_pro)
                       AND (CODING-IP-MAT* column 14 [oO]_Res|[oO]_np|[oO]_pro)
